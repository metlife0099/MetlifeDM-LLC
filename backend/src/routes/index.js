...
import { contactRoutes, consultationRoutes, newsletterRoutes, careerRoutes, partnerInquiryRoutes, pricingEnquiryRoutes } from './leadCapture.routes.js';
...
router.use('/pricing-enquiries', pricingEnquiryRoutes);
